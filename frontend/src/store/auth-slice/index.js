...
export const registerUser = createAsyncThunk(
  ...
  async (formData) => {
    const response = await axios.post(
      "https://e-commerce-website-yyp5.onrender.com/api/auth/register",
      formData,
      {
...
export const loginUser = createAsyncThunk(
  ...
  async (formData) => {
    const response = await axios.post(
      "https://e-commerce-website-yyp5.onrender.com/api/auth/login",
      formData,
      {
        withCredentials: true,
      }
...
export const logoutUser = createAsyncThunk(
  ...
  async () => {
    const response = await axios.post(
      "https://e-commerce-website-yyp5.onrender.com/api/auth/logout",
      {},
      {
        withCredentials: true,
      }
...
export const checkAuth = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://e-commerce-website-yyp5.onrender.com/api/auth/check-auth",
      {
        withCredentials: true,
        headers: {
          "Cache-Control":
